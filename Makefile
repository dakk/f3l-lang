...
# list-errors:
#  menhir --list-errors lib/passes/1_parsing/parser.mly > lib/passes/1_parsing/parser.messages

update-errors:
	menhir --update-errors lib/passes/1_parsing/parser.messages lib/passes/1_parsing/parser.mly > lib/passes/1_parsing/parser.messages
